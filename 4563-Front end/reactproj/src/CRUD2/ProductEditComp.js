...
const ProductEditComp2 = () => {
    ...
    useEffect(()=>{
        axios.get(`http://localhost:8848/products/${id}`).then((res)=>{
    ...
    const addProduct=(event)=>{
        ...
        axios.put(`http://localhost:8848/products/${id}`,product).then(()=>{
...
export default ProductEditComp2
